...
<div class="container-fluid">
        <div class="panel shadow">
            ...
            <div class="header">
                <h2 class="title"><i class="fas fa-plus-circle"></i> Asignacion de Personal a Cargo</h2>
                    ...
                    <div class="row">                       
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('idapproval', getTypePersonalOT('list', null),0,['class'=>'form-select', 'id' => 'idtype']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mtop16">
                            ...
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                {{ Form::time('fixture_date', Carbon\Carbon::now()->format('H:i'), ['class'=>'form-input']) }}
                            </div>
                        </div>
