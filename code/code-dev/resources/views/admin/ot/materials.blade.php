...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/ing_7') }}" class="nav-link"><i class="fas fa-copy"></i> OT</a>
    </li>
@endsection
...
<div class="container-fluid">
    <div class="panel shadow">
        ...
        <div class="header">
            <h2 class="title"><i class="fas fa-clipboard-list"></i> Listado de Materiales Usados en OT No. {{$ot->correlative}}  </h2>
            <ul>
