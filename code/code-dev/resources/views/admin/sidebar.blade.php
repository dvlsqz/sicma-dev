    ...
    <div class="main">
        <ul>
            ...
            @if(kvfj(Auth::user()->permissions, 'equipments_list'))
                <li>
                    <a href="{{ url('/admin/equipments/all') }}" class="lk-equipments_list lk-equipment_add lk-equipment_edit lk-equipment_file lk-equipment_parts lk-equipment_conecctions lk-equipment_transfer"><i class="fas fa-industry"></i> Equipos</a>
                </li>
            @endif
            ...
            @if(kvfj(Auth::user()->permissions, 'ing7_list'))
                <li>
                    <a href="{{ url('/admin/ing_7/1') }}" class="lk-ing7_list lk-ing7_add lk-ing7_buy_hire lk-ing7_classification lk-ing7_follow lk-ing7_assignments_areas lk-ing7_assignments_personal lk-ing7_record lk-ing7_materials lk-ing7_file"><i class="fas fa-copy"></i> ING-7</a>
                </li>
            @endif

            @if(kvfj(Auth::user()->permissions, 'ot_list'))
                <li>
                    <a href="{{ url('/admin/ot') }}" class="lk-ot_list lk-ot_add lk-ot_assignments_personal lk-ot_materials lk-ot_file"><i class="fas fa-clone"></i> OT's</a>
                </li>
            @endif
