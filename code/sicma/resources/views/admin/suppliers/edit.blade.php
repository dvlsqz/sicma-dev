...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/suppliers') }}" class="nav-link"><i class="fas fa-users"></i> Lista de Proveedors</a>
    </li>
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/supplier/'.$supplier->id.'/edit') }}" class="nav-link"><i class="fas fa-edit"></i> Editar Proveedor: {{$supplier->name}}</a>
    </li>
@endsection
...
@section('content')
    <div class="container-fluid">
        <div class="panel shadow">
            ...
            <div class="header">
                <h2 class="title"><i class="fas fa-edit"></i> Editar</h2>

            </div>

            <div class="inside">
                <form action="{{ url('/admin/supplier/'.$supplier->id.'/edit') }}" method="POST">
                    @csrf
                    <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                {!! Form::text('name_contact', $supplier->name_contact, ['class'=>'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                {!! Form::number('phone', $supplier->phone, ['class'=>'form-control']) !!}
                            </div>
                        </div>
