...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/kardex/egress/add') }}" class="nav-link"><i class="fas fa-times-circle"></i> Registrar Egreso</a>
    </li>
@endsection
...
@section('content')
    <div class="container-fluid">
        <div class="panel shadow">
            ...
            <div class="header">
                <h2 class="title"><i class="fas fa-times-circle"></i> Registrar Egreso</h2>
            </div>

            <div class="inside">
                {!!Form::open(array('url'=>'/admin/kardex/egress/add','method'=>'POST', 'autocomplete'=>'off'))!!}
                {{Form::token()}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <select name="idsupplier" id="idsupplier" style="width: 95%;">
