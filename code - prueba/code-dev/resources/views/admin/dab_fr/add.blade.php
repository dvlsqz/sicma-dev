...
@section('content')
    ...
    <div class="container-fluid">
        <div class="panel shadow">
            ...
            <div class="inside">
                {!!Form::open(array('url'=>'/admin/dab_75_fr/add','method'=>'POST', 'autocomplete'=>'off'))!!}
                {{Form::token()}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mtop16">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1"><i class="fas fa-layer-group"></i></span>
                            {!! Form::select('type_doc', getFormaDABAddArray('list',null), null,['class'=>'form-select']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mtop16">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                            {!! Form::text('ibm_accountable', null, ['class'=>'form-control']) !!}
                        </div>
                    </div>
